...
const dict: Dict = {
  ...
  share_with_contacts: { en: "Share with contacts", es: "Compartir con contactos" },
  share_search: { en: "Search contacts…", es: "Buscar contactos…" },
  share_send: { en: "Send to {n}", es: "Enviar a {n}" },
  share_send_one: { en: "Send to 1 contact", es: "Enviar a 1 contacto" },
  share_no_contacts: { en: "No contacts yet — add some first.", es: "Todavía no tenés contactos." },
  share_copy_link: { en: "Copy link instead", es: "Copiar link" },
  share_done: { en: "Shared with {n} contacts", es: "Compartido con {n} contactos" },
  notif_shared: { en: "shared an event with you:", es: "te compartió un evento:" },
